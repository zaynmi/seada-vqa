...
DEFAULT_TO_PATHS = ['/home/tang/sears_vqa/translation_models/english_french_model_acc_71.05_ppl_3.71_e13.pt',
                    '/home/tang/sears_vqa/translation_models/english_portuguese_model_acc_70.75_ppl_4.32_e13.pt']
DEFAULT_BACK_PATHS = ['/home/tang/sears_vqa/translation_models/french_english_model_acc_68.51_ppl_4.43_e13.pt',
                      '/home/tang/sears_vqa/translation_models/portuguese_english_model_acc_69.93_ppl_5.04_e13.pt']
...
class ParaphraseScorer(object):
    ...
    def generate_paraphrases(self, sentence, topk=10, threshold=None, edit_distance_cutoff=None, penalize_unks=True, frequent_ngrams=None):
        ...
        # Always include original sentence in this todo: no!!!
        orig = onmt_model.clean_text(sentence)
        output = {}
